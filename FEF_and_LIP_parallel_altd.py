...
from FEF_full3_altd import *
from LIP_full_altd import *
...
#    RSvm_FEF.ginp_RS=0* msiemens * cm **-2
    ...
    if theta_phase=='mixed':
        VIP_FEF=all_neurons_FEF[0]
        VIP_FEF.ginp_VIP_good='10* msiemens * cm **-2*(0.5+i*0.05)'
        RS_gran_LIP.ginp_RS_good='5* msiemens * cm **-2*(0.5+i*0.05)'
        FS_gran_LIP.ginp_FS_good='5* msiemens * cm **-2*(0.5+i*0.05)'
        RS_gran_LIP.ginp_RS_bad='5* msiemens * cm **-2*(0.5+i*0.05)'
        FS_gran_LIP.ginp_FS_bad='5* msiemens * cm **-2*(0.5+i*0.05)'
        VIP_FEF.ginp_VIP_bad='10* msiemens * cm **-2*(0.5+i*0.05)'
