...
from FEF_full3_alte import *
from LIP_full_alte import *
...
def FEF_and_LIP(simu,path):
    ...
    target_time,Atheta,Asqrtheta,Aalpha,N_simu=simu
...
#        input_beta2_IB=True
    ...
    all_neurons_FEF,all_synapses_FEF,all_monitors_FEF=create_FEF_full2(N_RS_vis,N_FS_vis,N_RS_mot,N_dSI_vm,N_RS_vm,N_gSI_vm,theta_phase,target_on,runtime,target_time,Atheta,Asqrtheta,Aalpha)
    ...
    all_neurons_LIP, all_synapses_LIP, all_gap_junctions_LIP, all_monitors_LIP=make_full_network(syn_cond,J,thal,theta_phase,Atheta,Asqrtheta,Aalpha)
...
#    RSvm_FEF.ginp_RS=0* msiemens * cm **-2
    ...
    S_LIP_RSv_FEF=generate_syn(RS_sup_LIP,RSv_FEF,'Isyn_LIP','',0.02*msiemens * cm **-2,0.125*ms,1*ms,0*mV)   
...
#    liste_target_time=[350*msecond,450*msecond,550*msecond,650*msecond,750*msecond,850*msecond,950*msecond,1050*msecond,1150*msecond,1250*msecond,1350*msecond,1450*msecond,1550*msecond,1650*msecond]
    ...
    Atheta=1
    Asqrtheta=0
    Aalpha=-5/2* msiemens * cm **-2*80*mV/50
