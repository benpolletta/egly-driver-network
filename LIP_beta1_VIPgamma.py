...
def create_Mark_Alex_network(kainate,version,target_time,Nf=1):
    ...
    all_neurons,all_synapses,all_gap_junctions,all_monitors=create_superficial_layer(kainate,version,target_time,Nf)
