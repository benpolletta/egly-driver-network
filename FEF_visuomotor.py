...
#    E_gran.J='20 * uA * cmeter ** -2'  #article SI=25, code=1
    ...
    SI_gran.J='-40 * uA * cmeter ** -2' #article=code=35
     #-30
...
#    SI_deep.J='35* uA * cmeter ** -2' #article SI=50, code=35, Mark = 45
    ...
    S_EgranEgran=generate_syn(E_gran,E_gran,'IsynRS_FEF_VM','',0.2*msiemens * cm **-2,0.125*ms,1*ms,0*mV) #0.4
    #S_EgranFSgran=generate_syn(E_gran,SI_gran,'IsynEgran','',0.2*usiemens * cm **-2*FLee,0.125*ms,1*ms,0*mV)
    S_EgranFSgran=generate_syn(E_gran,SI_gran,'IsynRS_FEF_VM','',0.35*msiemens * cm **-2,0.125*ms,1*ms,0*mV) #0.6
    ...
    S_FSgranEgran=generate_syn(SI_gran,E_gran,'IsynSI_FEF_VM','',0.25*msiemens * cm **-2,0.25*ms,20*ms,-80*mV) #0.35
    
    #S_FSgranFSgran=generate_syn(SI_gran,SI_gran,'IsynFSgran','',0.1* usiemens * cm **-2*FLee,0.25*ms,5*ms,-75*mV)
    S_FSgranFSgran=generate_syn(SI_gran,SI_gran,'IsynSI_FEF_VM','',1* msiemens * cm **-2,0.25*ms,20*ms,-75*mV) #1
...
#    S_SIdeepFSgran=generate_syn(SI_deep,SI_gran,'IsynSI2_FEF_VM','',1*msiemens * cm **-2,0.25*ms,20*ms,-80*mV)
    S_SIdeepFSgran=generate_syn(SI_deep,SI_gran,'IsynSI2_FEF_VM','',0.5*msiemens * cm **-2,0.25*ms,20*ms,-80*mV)
