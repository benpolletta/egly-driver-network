...
from mdPul_two_columns_v6 import *
...
#    S_LIP_VIPv_FEF=generate_syn(RS_sup_LIP,VIPv_FEF,'Isyn_LIP','',0.005*msiemens * cm **-2,0.125*ms,1*ms,0*mV)
    ...
    S_LIP_RSv_FEF=generate_syn(RS_sup_LIP,RSv_FEF,'Isyn_LIP','',0.005*msiemens * cm **-2,0.125*ms,1*ms,0*mV)   
    S_LIP_SIv_FEF=generate_syn(RS_sup_LIP,SIv_FEF,'Isyn_LIP','',0.01*msiemens * cm **-2,0.125*ms,1*ms,0*mV)   
    S_LIP_VIPv_FEF=generate_syn(RS_sup_LIP,VIPv_FEF,'Isyn_LIP','',0.0025*msiemens * cm **-2,0.125*ms,1*ms,0*mV)
    ...
    TC_inter.J='-0.1 * uA * cmeter ** -2' 
    TC_inter.Ca_i = '1e-7 * mole * metre**-3'
    TC_inter.run_regularly('J = -0.2 * (0.5+0.5*t/second) * uA * cmeter ** -2', dt=0.1*ms)
...
#    S_LIP_RS_inter_mdPul=generate_syn(RS_sup_LIP,TC_inter,'Isyn_LIP','',0.025*msiemens * cm **-2,0.125*ms,1*ms,0*mV)
    S_LIP_RS_inter_mdPul=generate_syn(IB_LIP_soma,TC_inter,'Isyn_LIP','',0.05*msiemens * cm **-2,0.125*ms,1*ms,0*mV)  #0.025*msiemens * cm **-2
...
#    S_RS_inter_VIPv_FEF=generate_syn(RS_inter,VIPv_FEF,'Isyn_LIP','',0.005*msiemens * cm **-2,0.125*ms,1*ms,0*mV)
    S_RS_inter_RSv_FEF=generate_syn(TC_inter,RSv_FEF,'Isyn_mdPul','',0.05*msiemens * cm **-2,0.125*ms,1*ms,0*mV)   
    S_RS_inter_SIv_FEF=generate_syn(TC_inter,SIv_FEF,'Isyn_mdPul','',0.05*msiemens * cm **-2,0.125*ms,1*ms,0*mV)   
    S_RS_inter_VIPv_FEF=generate_syn(TC_inter,VIPv_FEF,'Isyn_mdPul','',0.005*msiemens * cm **-2,0.125*ms,1*ms,0*mV)

#    gGABA_A_HTC_TC_inter = 0.2 * msiemens * cm **-2
    gGABA_A_HTC_TC_inter = 0.1 * msiemens * cm **-2
    ...
    #connecting TC_inter back to the RE cells in mdPul
    gAMPA_TC_RE = 0.01 * msiemens * cm **-2
    RE_A=all_neurons_mdPul[4]
    S_TCinter_RE=generate_syn(TC_inter,RE_A,'IsynTCinter','',gAMPA_TC_RE,0.125*ms,1*ms,0*mV)
...
#    print(len(all_neurons_FEF),len(all_neurons_LIP))
    all_synapses=all_synapses_FEF+all_synapses_LIP+all_synapses_mdPul+(S_FEF_IB_LIP,S_FEF_SIdeep_LIP,S_LIP_RS_FEF,S_LIP_FS_FEF,S_LIP_RSv_FEF,S_LIP_SIv_FEF,S_LIP_VIPv_FEF,S_LIP_RS_inter_mdPul,S_RS_inter_RSv_FEF,S_RS_inter_SIv_FEF,S_RS_inter_VIPv_FEF)+(S_TC_A_RSg_LIP,S_TC_A_FSg_LIP,S_TC_A_VIP_FEF,synHTCTCinter,S_RS_decision_IB_SC,S_IBIB,S_TCinter_RE)
...
#    net.add(all_monitors)
    ...
    R8,R9,R10,V_RS,V_FS,V_SI,R11,R12,R13,R14,mon_RS, V1,V2,V3,R1,R2,R3,I1,I2,I3,V4,R4,I4s,I4a,I4ad,I4bd,R5,R6,R7,V5,V6,V7,inpmon,inpIBmon,R1A,R2A,V1A,V2A,I1A,I2A,I3A,R1B,R2B,V1B,V2B,I1B,I2B,I3B,RA,RB,EA,EB,IA,IB,Rinter,IBSC=all_monitors
