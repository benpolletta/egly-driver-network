...
def create_superficial_layer(kainate,version,target_time,Nf=1):
...
#    RS.J='1 * uA * cmeter ** -2'
    ...
    SI=NeuronGroup(N_SI,eq_SI_LIP_VIPgamma,threshold='V>-20*mvolt',refractory=3*ms,method='rk4',name='SIsupLIP')
