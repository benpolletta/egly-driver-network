...
from FEF_full3_no_SI_rec_noVIP_alternate_v2 import *
from LIP_full_noVIP_alternate_v2 import *
...
#        input_beta2_IB=True
    ...
    all_neurons_FEF,all_synapses_FEF,all_monitors_FEF=create_FEF_full2(N_RS_vis,N_FS_vis,N_RS_mot,N_dSI_vm,N_RS_vm,N_gSI_vm,t_SI,t_FS,theta_phase,target_on,runtime,target_time)
