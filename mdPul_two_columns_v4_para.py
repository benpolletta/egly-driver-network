...
def create_mdPul(N_HTC,N_TC,N_RE,condition,in_mode,theta_phase,g_REHTC_GABAA,g_REHTC_GABAB):
...
#    g_REHTC_GABAA=0.07 * msiemens * cm **-2 #for lateral inhibition
#    g_REHTC_GABAB=0.07 * msiemens * cm **-2
#    g_REHTC_GABAA=0.01 * msiemens * cm **-2 #for lateral inhibition
#    g_REHTC_GABAB=0.15 * msiemens * cm **-2
#    g_RERE=0.3 * msiemens * cm **-2
#    g_AB=1
    
    S_RE_A_HTC_B_GABAA=Synapses(RE_A,HTC_B,model='IsynREA'+eq_syn)
    S_RE_A_HTC_B_GABAA.connect()
    S_RE_A_HTC_B_GABAA.g_i=g_REHTC_GABAA
    S_RE_A_HTC_B_GABAA.taur_i=0.25*ms
    S_RE_A_HTC_B_GABAA.taud_i=5*ms
#    S_RE_A_HTC_B_GABAA.taud_i=10*ms
    S_RE_A_HTC_B_GABAA.V_i=-80*mV
    
    S_RE_B_HTC_A_GABAA=Synapses(RE_B,HTC_A,model='IsynREA'+eq_syn)
    S_RE_B_HTC_A_GABAA.connect()
    S_RE_B_HTC_A_GABAA.g_i=g_REHTC_GABAA
    S_RE_B_HTC_A_GABAA.taur_i=0.25*ms
    S_RE_B_HTC_A_GABAA.taud_i=5*ms
#    S_RE_B_HTC_A_GABAA.taud_i=10*ms
    S_RE_B_HTC_A_GABAA.V_i=-80*mV
    
    S_RE_A_HTC_B_GABAB=Synapses(RE_A,HTC_B,model='IsynREB'+eq_syn)
    S_RE_A_HTC_B_GABAB.connect()
    S_RE_A_HTC_B_GABAB.g_i=g_REHTC_GABAB
    S_RE_A_HTC_B_GABAB.taur_i=25*ms
#    S_RE_A_HTC_B_GABAB.taur_i=50*ms
    S_RE_A_HTC_B_GABAB.taud_i=100*ms
#    S_RE_A_HTC_B_GABAB.taud_i=200*ms
    S_RE_A_HTC_B_GABAB.V_i=-95*mV
    
    S_RE_B_HTC_A_GABAB=Synapses(RE_B,HTC_A,model='IsynREB'+eq_syn)
    S_RE_B_HTC_A_GABAB.connect()
    S_RE_B_HTC_A_GABAB.g_i=g_REHTC_GABAB
    S_RE_B_HTC_A_GABAB.taur_i=25*ms
#    S_RE_B_HTC_A_GABAB.taur_i=50*ms
    S_RE_B_HTC_A_GABAB.taud_i=100*ms
#    S_RE_B_HTC_A_GABAB.taud_i=200*ms
    S_RE_B_HTC_A_GABAB.V_i=-95*mV


    gGABA_A_RE_RE = 0.07 * msiemens * cm **-2
    gGABA_A_RE_HTC = 0.0007 * msiemens * cm **-2
    gGABA_A_RE_TC = 0.01 * msiemens * cm **-2
    gGABA_B_RE_HTC = 0.001 * msiemens * cm **-2
...
#    gAMPA_HTC_RE = 0.0225 * msiemens * cm **-2
    ...
    all_synapses=all_synapsesA,all_synapsesB+(S_RE_A_HTC_B_GABAA,S_RE_B_HTC_A_GABAA,S_RE_A_HTC_B_GABAB,S_RE_B_HTC_A_GABAB,synRERE_A,synREHTC_A,synRETC_A,synHTCRE_A,synTCRE_A,synBREHTC_A,synBRETC_A, synRERE_B,synREHTC_B,synRETC_B,synHTCRE_B,synTCRE_B,synBREHTC_B,synBRETC_B)
...
#    liste_g_REHTC_GABAA=[0*msiemens * cm **-2,0.25*msiemens * cm **-2,0.5*msiemens * cm **-2,0.75*msiemens * cm **-2,1*msiemens * cm **-2]
#    liste_g_REHTC_GABAB=[0*msiemens * cm **-2,0.01*msiemens * cm **-2,0.025*msiemens * cm **-2,0.05*msiemens * cm **-2,0.075*msiemens * cm **-2,0.1*msiemens * cm **-2]
    liste_g_REHTC_GABAA=[0.5*msiemens * cm **-2,0.75*msiemens * cm **-2,0.875*msiemens * cm **-2,1*msiemens * cm **-2,1.125*msiemens * cm **-2,1.25*msiemens * cm **-2,1.5*msiemens * cm **-2]
    liste_g_REHTC_GABAB=[0.025*msiemens * cm **-2,0.0375*msiemens * cm **-2,0.05*msiemens * cm **-2,0.0625*msiemens * cm **-2,0.075*msiemens * cm **-2]
     
    for g_REHTC_GABAA in liste_g_REHTC_GABAA:
        for g_REHTC_GABAB in liste_g_REHTC_GABAB:
            print(g_REHTC_GABAA,g_REHTC_GABAB)
...
#            in_mode='single_spike'
        ...
        #    gapp=0.1*mamp * cmeter ** -2 # in HTC cells
            ...
            net=Network()
            all_neurons,all_synapses,all_gap_junctions,all_monitors=create_mdPul(N_HTC,N_TC,N_RE,condition,in_mode,theta_phase,g_REHTC_GABAA,g_REHTC_GABAB)
        ...
        #            net.add(elem)
            ...
            legend()  
            title(str((g_REHTC_GABAA,g_REHTC_GABAB)))
