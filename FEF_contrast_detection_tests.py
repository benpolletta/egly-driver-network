...
#    RS.J='55 * uA * cmeter ** -2'  #article SI=25, code=1
    #0 
#    RS.J='30 * uA * cmeter ** -2'  #article SI=25, code=1
...
#    VIP.Iapp='5.15 * uA * cmeter ** -2' 
    ...
    S_RSFS=generate_syn(RS,FS,'IsynRS_FEF_VM','i//10==j//10',0.5* msiemens * cm **-2,0.125*ms,1*ms,0*mV) 
    ...
    S_FSFS=generate_syn(FS,FS,'IsynSI_FEF_VM','i//10==j//10',0.8* msiemens * cm **-2,0.25*ms,5*ms,-80*mV) 
