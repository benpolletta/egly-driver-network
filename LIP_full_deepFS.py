...
#    print(input_mixed,input_beta2_IB,input_beta2_RS,input_beta2_FS_SI,input_thalamus_gran)
    ...
    FS_deep=NeuronGroup(N_FS,eq_FS_LIP,threshold='V>-20*mvolt',refractory=3*ms,method='rk4')
    FS_deep.V = '-110*mvolt+10*rand()*mvolt'
    FS_deep.h = '0+0.05*rand()'
...
#    tight_layout()
    ...
    plot(R5.t,R5.i+90,'.',label='Granular RS',color='C1')
    plot(R6.t,R6.i+70,'c.',label='Granular FS')
