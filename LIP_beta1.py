...
#    S_IBVIP.g_i=0.45* msiemens * cm **-2*int(version=='Alex')+(0.4*msiemens * cm **-2)*int(version=='Mark')+(0.02*msiemens * cm **-2)*int(version=='Mark/cell')
    S_IBVIP.g_i=0.005* msiemens * cm **-2
...
if __name__=='__main__' :
    ...
    #LFP_I_IB=1/N_IB*(sum(I5s.Isyn,axis=0)[min_t:]+sum(I5a.Isyn,axis=0)[min_t:]+sum(I5ad.Isyn,axis=0)[min_t:]+sum(I5bd.Isyn,axis=0)[min_t:])
    #
