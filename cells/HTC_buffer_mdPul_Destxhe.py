...
eq_HTC_buffer_mdPul='''
    ...
    ITLT = gTLT_HTC * mTLT**2 * hTLT * (V-ETLT) : amp * meter ** -2
        ...
        dCa_iTLT/dt = ((-10000*ITLT)/(2*96485.3* coulomb * mole ** -1 * meter)- (Ca_iTLT-0.00024*mmolar)/5/ms ) : mole * meter**-3
    ...
    ITHT = gTHT_HTC * mTHT**2 * hTHT * (V-ETHT) : amp * meter ** -2
        ...
        dCa_iTHT/dt = ((-10000*ITHT)/(2*96485.3* coulomb * mole ** -1 * meter)- (Ca_iTHT-0.00024*mmolar)/5/ms ) : mole * meter**-3
...
gL_HTC=0.015e-3 * siemens * cm **-2  
EL_HTC=-70*mV
#gKL_HTC=0.0069e-3 * siemens * cm **-2   
gKL_HTC=0.015e-3 * siemens * cm **-2  
