...
#    gGABA_A_HTC_TC = 0.2 * msiemens * cm **-2
    gGABA_A_HTC_TC = 0.1 * msiemens * cm **-2
    ...
    synRERE=generate_syn(RE,RE,'IsynRE','',gGABA_A_RE_RE,0.25*ms,5*ms,-80*mV)
    synREHTC=generate_syn(RE,HTC,'IsynREintGABAA','',gGABA_A_RE_HTC,0.25*ms,5*ms,-80*mV)
    synRETC=generate_syn(RE,TC,'IsynREGABAA','',gGABA_A_RE_TC,0.25*ms,5*ms,-80*mV)

    gGABA_B_RE_HTC = 0.001 * msiemens * cm **-2
    gGABA_B_RE_TC = 0.02 * msiemens * cm **-2
    synBREHTC=generate_syn(RE,HTC,'IsynREintGABAB','',gGABA_B_RE_HTC,25*ms,100*ms,-95*mV)
    synBRETC=generate_syn(RE,TC,'IsynREGABAB','',gGABA_B_RE_TC,25*ms,100*ms,-95*mV)

    gAMPA_HTC_RE = 0.01 * msiemens * cm **-2
    synHTCRE=generate_syn(HTC,RE,'IsynHTC','',gAMPA_HTC_RE,0.125*ms,1*ms,0*mV)
    gAMPA_TC_RE = 0.01 * msiemens * cm **-2
    synTCRE=generate_syn(TC,RE,'IsynTC','',gAMPA_TC_RE,0.125*ms,1*ms,0*mV)
...
#        TC.ginp_TC2=gEPSP_TC2
    ...
    all_neurons=HTC,TC,RE
    all_synapses=(synHTCTC,synRERE,synREHTC,synRETC,synHTCRE,synTCRE,synBREHTC,synBRETC)
    all_synapses=tuple([y for y in all_synapses if y])
    all_monitors=R1,R2,R3,V1,V2,I2,I3,I4
...
#    R1,R2,R3,V1,V2,V3=all_monitors
    R1,R2,R3,V1,V2,I2,I3,I4=all_monitors
