...
#    runtime=5*second
    ...
    syn_cond,J,thal,theta_phase,gap,g_h,index=simu
...
#    all_gap=[0.2* msiemens * cm **-2]
#    all_g_h=[25 * msiemens * cm **-2]
    all_gap=[0.01* msiemens * cm **-2,0.1* msiemens * cm **-2,0.2* msiemens * cm **-2,0.5* msiemens * cm **-2,1* msiemens * cm **-2]
    all_g_h=[15 * msiemens * cm **-2,20 * msiemens * cm **-2,25 * msiemens * cm **-2,30 * msiemens * cm **-2,35 * msiemens * cm **-2]
...
#    all_theta=['mixed','mixed','mixed','mixed','mixed']
    ...
    all_sim=list(product(all_syn_cond,all_J,all_thal,all_theta,all_gap,all_g_h))
    index_var=[-1]
