...
def create_FEF_full2(N_RS_vis,N_FS_vis,N_RS_mot,N_dSI_vm,N_RS_vm,N_gSI_vm,t_SI,t_FS,theta_phase,target_on,runtime,target_time):
    
    #create each functional group of neurons individually
    all_neurons_vm,all_synapses_vm,all_monitors_vm=generate_deepSI_and_gran_layers(t_SI,t_FS,theta_phase,N_dSI_vm,N_RS_vm,N_gSI_vm,runtime)
...
#    print(all_neurons_v)
#    print(VIP.ginp_VIP2,SI.ginp_SI2)
#    print(SI.ginp_SI,VIP.ginp_VIP_good,VIP.ginp_VIP_bad)
#    print(Poisson_target.spike_time)
#    print(VIP.Iapp,SI.J)
#    print()
#    print(all_synapses_v)
...
#    R1,R2,R3,V1,V2,V3,R4,R5,V4,V5,R6,R7,V6,V7,R8,mon_RS=all_monitors
    R1,R2,R3,V1,V2,V3,inp_mon,R4,R5,R6,R7,mon_RS=all_monitors
