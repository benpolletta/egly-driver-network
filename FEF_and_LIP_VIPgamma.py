...
#        input_beta2_IB=True
    ...
    V1,V2,V3,R1,R2,R3,RVIP,I1,I2,I3,V4,R4,I4s,I4a,I4ad,I4bd,R5,R6,R7,V5,V6,V7,inpmon,inpIBmon=all_monitors_LIP
    RS_sup_LIP,SI_sup_LIP,IB_LIP,SI_deep_LIP=all_neurons_LIP[0],all_neurons_LIP[2],all_neurons_LIP[6],all_neurons_LIP[10]
    RS_gran_LIP,FS_gran_LIP=all_neurons_LIP[8],all_neurons_LIP[9]
    
    IB_LIP.ginp_IB=0* msiemens * cm **-2 #the input to RS_sup_LIP is provided with synapses from FEF 
    SI_sup_LIP.ginp_SI=30* msiemens * cm **-2
    SI_deep_LIP.ginp_SI=30* msiemens * cm **-2
