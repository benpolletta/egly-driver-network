...
from FEF_full3_alternatec import *
from LIP_full_alternatec import *
...
def FEF_and_LIP(simu,path):
    ...
    target_time,N_simu,f_mdPul=simu[0],simu[1],simu[2]
...
#        input_beta2_IB=True
    ...
    all_neurons_FEF,all_synapses_FEF,all_monitors_FEF=create_FEF_full2(N_RS_vis,N_FS_vis,N_RS_mot,N_dSI_vm,N_RS_vm,N_gSI_vm,f_mdPul,theta_phase,target_on,runtime,target_time)
    ...
    all_neurons_LIP, all_synapses_LIP, all_gap_junctions_LIP, all_monitors_LIP=make_full_network(syn_cond,J,thal,f_mdPul,theta_phase)
...
#    liste_simus=[[350*msecond,0,20*Hz]]
    ...
    for t in liste_target_time:
        liste_simus+=[t]*N
    i0=6
    liste_simus=[[liste_simus[i],10*i+i0,25*Hz] for i in range(len(liste_simus))]
    liste_simus=[liste_simus[540]]
