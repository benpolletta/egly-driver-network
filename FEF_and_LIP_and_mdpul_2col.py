...
#    all_neurons=all_neurons_FEF+all_neurons_LIP+all_neurons_mdPul+(TC_inter,)
#    all_synapses=all_synapses_FEF+all_synapses_LIP+all_synapses_mdPul#+(S_FEF_IB_LIP,S_FEF_SIdeep_LIP,S_LIP_RS_FEF,S_LIP_FS_FEF,S_LIP_RS_inter_mdPul,S_RS_inter_RSv_FEF,S_RS_inter_SIv_FEF,S_RS_inter_VIPv_FEF)+(S_TC_A_RSg_LIP,S_TC_A_FSg_LIP,S_TC_A_VIP_FEF,synHTCTCinter)
#    all_monitors=all_monitors_FEF+all_monitors_LIP+all_monitors_mdPul+(TCinter,)
