...
#    E_B.J='10 * uA * cmeter ** -2'  #article SI=25, code=1
    ...
    I_A=NeuronGroup(20,eq_FS_FEF,threshold='V>-20*mvolt',refractory=3*ms,method='rk4')
...
#    I_A.J = '10 * uA * cmeter ** -2'
    ...
    I_B=NeuronGroup(20,eq_FS_FEF,threshold='V>-20*mvolt',refractory=3*ms,method='rk4')
...
#    HTC_A.V='-10*mvolt+20*mvolt*rand()'
    ...
    E_A.V='-50*mvolt+5*mvolt*rand()'
    I_A.V='-50*mvolt+5*mvolt*rand()'
    
    g_TC_E=0.1 * msiemens * cm **-2
#    g_E_HTC=0.2 * msiemens * cm **-2
    g_E_HTC=0.085 * msiemens * cm **-2
...
#    g_I_I=0.75 * msiemens * cm **-2
    g_E_I=1 * msiemens * cm **-2
    g_E_E=0 * msiemens * cm **-2
    g_I_E=1 * msiemens * cm **-2
    g_I_I=0.75 * msiemens * cm **-2
    ...
    synIA_EB=generate_syn(I_B,E_A,'IsynFS_FEF_V','',g_I_E,0.25*ms,5*ms,-80*mV)
    synIB_EA=generate_syn(I_A,E_B,'IsynFS_FEF_V','',g_I_E,0.25*ms,5*ms,-80*mV)
    synIA_IA=generate_syn(I_A,I_A,'IsynFS_FEF_V','',g_I_I,0.25*ms,5*ms,-80*mV)
    synIB_IB=generate_syn(I_B,I_B,'IsynFS_FEF_V','',g_I_I,0.25*ms,5*ms,-80*mV)
...
#    gAMPA_HTC_RE = 0.0225 * msiemens * cm **-2
    ...
    gGABA_A_RE_HTC = 0.01 * msiemens * cm **-2
    gGABA_B_RE_HTC = 0.002 * msiemens * cm **-2
