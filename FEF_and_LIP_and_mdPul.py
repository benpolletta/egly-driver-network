...
#        input_beta2_IB=True
    ...
    all_neurons_mdPul,all_synapses_mdPul,all_monitors_mdPul=create_mdPul(N_TC,N_RE)
    R1A,R2A,R1B,R2B,R1C,R2C,V1A,V2A=all_monitors_mdPul
    ...
    SI2vm_FEF.ginpVIP=0* msiemens * cm **-2
    RS_gran_LIP.ginp_RS=5* msiemens * cm **-2
    FS_gran_LIP.ginp_FS=5* msiemens * cm **-2
...
#        SIvm_FEF.ginp_SI=10* msiemens * cm **-2
    ...
    S_FEF_IB_LIP=generate_syn(RSvm_FEF,IB_LIP,'Isyn_FEF','',0.4*msiemens * cm **-2,0.125*ms,1*ms,0*mV)
    S_FEF_SIdeep_LIP=generate_syn(RSvm_FEF,SI_deep_LIP,'Isyn_FEF','',0.4*msiemens * cm **-2,0.125*ms,1*ms,0*mV)
    ...
    S_LIP_mdPul=generate_syn(RS_sup_LIP,TC_B,'Isyn_LIP','',0*msiemens * cm **-2,0.125*ms,1*ms,0*mV)    

    S_mdPul_FEF_VIP=generate_syn(TC_B,SI2vm_FEF,'Isyn_mdPul','',3*msiemens * cm **-2,0.125*ms,1*ms,0*mV)
    S_mdPul_LIP_RSg=generate_syn(TC_B,RS_gran_LIP,'Isyn_mdPul','',0.2*msiemens * cm **-2,0.125*ms,1*ms,0*mV)    
    S_mdPul_LIP_FSg=generate_syn(TC_B,FS_gran_LIP,'Isyn_mdPul','',0.2*msiemens * cm **-2,0.125*ms,1*ms,0*mV)    
