...
#    E_gran.J='20 * uA * cmeter ** -2'  #article SI=25, code=1
    ...
    SI_gran=NeuronGroup(N_SI_gran,eq_FS_FEF,threshold='V>-20*mvolt',refractory=3*ms,method='rk4')
...
#    SI_deep.J='35* uA * cmeter ** -2' #article SI=50, code=35, Mark = 45
    ...
    S_FSgranFSgran=generate_syn(SI_gran,SI_gran,'IsynSI_FEF_VM','',0.3* msiemens * cm **-2,0.25*ms,5*ms,-75*mV) #1
